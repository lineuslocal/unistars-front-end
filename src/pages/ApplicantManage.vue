      ...
      <div class="cus-event">
        <q-list class="bg-white" separator bordered>
          <q-item v-ripple class="row cus-event-detail">
            ...
            <q-item-section class="col-3">
             ...
             <q-item-section class="col-2">
              <q-item-label>Personnel</q-item-label>
            </q-item-section>
          </q-item>
          <q-item v-for="(event, index) in events" :key="event.id" v-ripple class="row cus-event-detail">
            ...
            <q-item-section class="col-5 ">
              <q-item-label clickable @click="toDetailApplicantList(event.id, index)">{{event.title}}</q-item-label>
            </q-item-section>
            <q-item-section class="col-2">
              <q-item-label>{{event.date}}</q-item-label>
            </q-item-section>
            <q-item-section class="col-4">
              <q-item-label class="text-center">{{event.reg}}/{{event.maxSeat}}</q-item-label>
            </q-item-section>
