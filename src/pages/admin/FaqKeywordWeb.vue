<template>
  <q-page style="margin-top:30px">
    <q-tabs
      ...
      inline-label
    >
        <q-tab name="cat" label="Category" icon="collections_bookmark"/>
        <q-tab name="key" label="Keyword" icon="keyboard"/>
        <q-tab name="faq" label="Faq" icon="help"/>
    ...
    <q-tab-panels v-model="tab" animated
      ...
      infinite> 
        ...
        <q-tab-panel name="cat"></q-tab-panel>
         <q-tab-panel name="faq"></q-tab-panel>
    </q-tab-panels>
  </q-page>
</template>
