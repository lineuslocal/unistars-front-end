const routes = [
  {
    ...
    children: [
      { path: '', name: 'Login', component: () => import('pages/client/Login.vue'), meta: { showHeader: true } },
      { path: '/user/register', name: 'Register', component: () => import('pages/client/Register.vue'), meta: { showHeader: true, showBack: true } },
      { path: '/user/reset', name: 'Reset', component: () => import('pages/client/Reset.vue'), meta: { showHeader: true, showBack: true } },
      { path: '/user/verify', name: 'verify', component: () => import('pages/client/Verify.vue'), meta: { showHeader: true, showBack: true } },
      { path: '/user/home', name: 'HomePage', component: () => import('pages/client/Index.vue') },
